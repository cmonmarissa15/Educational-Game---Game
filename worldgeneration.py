...
time_left = 2000  # Initial time in seconds
...
def generateWorld(worldx,worldy,window_width,window_height,background, nightbackground, streamAppearancesByAim, streamNightAppearancesByAim, streamDimensionsByAim, streamCurveCoefficients, treeGraphics, treeNightGraphics, treeGreenness, rockGraphics, rockNightGraphics, decorGraphics, decorNightGraphics, decorDynamics, printGraphicsSmall, miscellaneousGraphics, miscellaneousNightGraphics, Den_call):
    ...
    def digDen(worldx,worldy,window_width,window_height,streams,obstacles,miscellaneousGraphics,miscellaneousNightGraphics,time_left):
        # if time_left == 1000:
    ...
    myden = digDen(worldx,worldy,window_width,window_height,mystreams,myforest + myrocks,miscellaneousGraphics,miscellaneousNightGraphics,time_left)
...
def makeHuntWorld(oldworld,centerx,centery,window_width,window_height,prey,animalGraphics,night,pack=False,wolfGraphics={ },maincharname='',packmemcount=0,chapter={}):
    ...
    def birthPreyAnimal(borders,window_width,window_height,animal,obstacles,animalGraphics):
        ...
        preycounts = {'rabbit':random.randint(3,10),'deer':random.randint(1,5),'bison':1}
