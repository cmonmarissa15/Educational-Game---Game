...
def settings_screen(screen,menuGraphics):
    ...
    def draw_settings_screen(screen,menuGraphics,window_width,window_height):
        ...
        if position3 == 0:
            ...
            screen.blit(menuGraphics['indicator'],positionslist2[position2])

        #screen.blit(menuGraphics['indicator2'],positionslist1[position1])

            screen.blit(menuGraphics['indicator_high'],positionslist1[position1])

            #screen.blit(menuGraphics['indicator3'],positionslist2[position2])

        elif position3 == 1:

            screen.blit(menuGraphics['indicator'],positionslist1[position1])

            screen.blit(menuGraphics['indicator_high'],positionslist2[position2])
            ...
            if event.type == pygame.QUIT:  # If 'x' button selected, end
                ...
                if event.key == pygame.K_UP: # and position3 == 1: # pos 3 reflects
                    ...
                    if position3 == 0:
                        ...
                        elif position1 < 20: #len(positionslist1):
                        ...
                        elif position2 < 20: #len(positionslist2):
