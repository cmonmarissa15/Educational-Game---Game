#Gray Wolf Conservation Status sub-page

def graywolf_conservation(): 
    import pygame
    import SpeciesMenu
    import Species_GrayWolf
    
    print("Gray Wolf conservation status is running")
    ...
    # Load all images
    GrayWolf_Image = pygame.image.load('./Assets/GrayWolf/Conservation.png')
