#Gray Wolf Unique traits, behaviors and abilities sub-page
...
def graywolf_traits(): 
    ...
    print("Gray Wolf unique traits is running")
   ...
   # initializing the constructor 
    ...
    # Load all images
    GrayWolf_Image = pygame.image.load('./Assets/GrayWolf/Traits.png')
    traits_popout1 = pygame.image.load('./Assets/GrayWolf/Traits-Popout1.png')
    traits_popout2 = pygame.image.load('./Assets/GrayWolf/Traits-Popout2.png')
    traits_popout3 = pygame.image.load('./Assets/GrayWolf/Traits-Popout3.png')
    traits_popout4 = pygame.image.load('./Assets/GrayWolf/Traits-Popout4.png')
    traits_popout5 = pygame.image.load('./Assets/GrayWolf/Traits-Popout5.png')
    traits_popout6 = pygame.image.load('./Assets/GrayWolf/Traits-Popout6.png')
