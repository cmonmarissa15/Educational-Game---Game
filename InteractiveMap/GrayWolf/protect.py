#Gray Wolf "How can people protect Bison"

def graywolf_protect(): 
    import pygame
    import SpeciesMenu
    import Species_GrayWolf
    
    print("Gray Wolf how to protect is running")
    ...
    # Load all images
    GrayWolf_Image = pygame.image.load('./Assets/GrayWolf/Protect.png')
