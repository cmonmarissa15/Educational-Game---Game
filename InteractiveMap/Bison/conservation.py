#Bison Conservation Status sub-page

def bison_conservation(): 
    import pygame
    import SpeciesMenu
    import Species_Bison
    
    print("Bison conservation is running")
    ...
    # Load all images
    bison_Image = pygame.image.load('./Assets/Bison/Conservation.png')
