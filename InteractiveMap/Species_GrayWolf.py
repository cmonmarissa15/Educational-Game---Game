    ...
    while True: 
        for ev in pygame.event.get(): 
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN: 
                if  20 <= mouse[0] <= width / 5 + 20 and height/4 <= mouse[1] <= height/2 + 50:                     Identification.graywolf_id()
                if  width/5 + 20 <= mouse[0] <= 2*width/5 + 10 and height/4 <= mouse[1] <= height/2 + 50:           Traits.graywolf_traits()
                if  2*width/5+10 <= mouse[0] <= 3*width/5 and height/4 <= mouse[1] <= height/2 + 50:                Diet.graywolf_diet()
                if  3*width/5 <= mouse[0] <= 4*width/5 - 10 and height/4 <= mouse[1] <= height/2 + 50:              Habitat.graywolf_habitat()
                if  4*width/5 -10 <= mouse[0] <= width - 20 and height/4 <= mouse[1] <= height/2 + 50:              Threats.graywolf_threats()
                if  20 <= mouse[0] <= width / 5 + 20 and height/2 + 50 <= mouse[1] <= 3*height/4 + 100:             Ecosystem.graywolf_ecosystem()
                if  width/5 + 20 <= mouse[0] <= 2*width/5 + 10 and height/2 + 50 <= mouse[1] <= 3*height/4 + 100:   Conservation.graywolf_conservation()
                if  2*width/5+10 <= mouse[0] <= 3*width/5 and height/2 + 50 <= mouse[1] <= 3*height/4 + 100:        WolfPark.graywolf_wolfpark()
                if  3*width/5 <= mouse[0] <= 4*width/5 - 10 and height/2 + 50 <= mouse[1] <= 3*height/4 + 100:      Protect.graywolf_protect()
        ...
        # Sets the Gray Wolf Species Page as the BACKGROUND 
        GrayWolf_Image = pygame.image.load('./Assets/GrayWolf/SpeciesPage-GrayWolf.png')
        ...
        # if mouse is hovered over eighth button (Gray Wolves at Wolf Park) it changes to lighter shade 
        ...
        # if mouse is hovered over ninth button (How can people protect Gray Wolves?) it changes to lighter shade 
