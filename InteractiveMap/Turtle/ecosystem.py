#Turtle Role in the Ecosystem

def turtle_ecosystem(): 
    import pygame
    import SpeciesMenu
    import Species_Turtle
    
    print("Turtle role in the ecosystem is running")
    ...
    # Load all images
    Turtle_Image = pygame.image.load('./Assets/Turtles/Ecosystem.png')
