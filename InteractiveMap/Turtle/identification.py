#Turtle Identification sub-page
...
def turtle_id(): 
    ...
    print("Turtle identification is running")
    ...
    # Load all images
    Turtle_Image = pygame.image.load('./Assets/Turtles/Identification.png')
    identification_popout1 = pygame.image.load('./Assets/Turtles/Identification-Popout1.png')
    identification_popout2 = pygame.image.load('./Assets/Turtles/Identification-Popout2.png')
    identification_popout3 = pygame.image.load('./Assets/Turtles/Identification-Popout3.png')
