#Turtle Conservation Status sub-page

def turtle_conservation(): 
    import pygame
    import SpeciesMenu
    import Species_Turtle
    
    print("Turtle conservation status is running")
    ...
    # Load all images
    Turtle_Image = pygame.image.load('./Assets/Turtles/Conservation.png')
