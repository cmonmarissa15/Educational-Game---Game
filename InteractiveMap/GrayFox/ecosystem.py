#Gray Fox Role in the Ecosystem

def grayfox_ecosystem(): 
    import pygame
    import SpeciesMenu
    import Species_GrayFox
    
    print("Gray Fox role in the ecosystem is running")
    ...
    # Load all images
    GrayFox_Image = pygame.image.load('./Assets/GrayFox/Ecosystem.png')
