#Gray Fox Conservation Status sub-page

def grayfox_conservation(): 
    import pygame
    import SpeciesMenu
    import Species_GrayFox
    
    print("Gray Fox conservation status is running")
    ...
    # Load all images
    GrayFox_Image = pygame.image.load('./Assets/GrayFox/Conservation.png')
