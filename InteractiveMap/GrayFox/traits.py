#Gray Fox Unique traits, behaviors and abilities sub-page
...
def grayfox_traits(): 
    ...
    print("Gray Fox unique traits is running")
    ...
    # Load all images
    GrayFox_Image = pygame.image.load('./Assets/GrayFox/Traits.png')
