#Red Fox Unique traits, behaviors and abilities sub-page
...
def redfox_traits(): 
    ...
    print("Red Fox unique traits is running")
    ...
    # Load all images
    RedFox_Image = pygame.image.load('./Assets/RedFox/Traits.png')
    traits_popout1 = pygame.image.load('./Assets/RedFox/Traits-Popout1.png')
    traits_popout2 = pygame.image.load('./Assets/RedFox/Traits-Popout2.png')
    traits_popout3 = pygame.image.load('./Assets/RedFox/Traits-Popout3.png')
    traits_popout4 = pygame.image.load('./Assets/RedFox/Traits-Popout4.png')
    traits_popout5 = pygame.image.load('./Assets/RedFox/Traits-Popout5.png')
    traits_popout6 = pygame.image.load('./Assets/RedFox/Traits-Popout6.png')
    ...
    while True: 
        ...
        # Sets the Red Fox Page as the BACKGROUND 
        ...
        # if mouse is hovered over the back button (Go back to Red Fox page) it changes to lighter shade 
        if  width/4-40 <= mouse[0] <= width/2 - 20 and height - 90 <= mouse[1] <= height: 
