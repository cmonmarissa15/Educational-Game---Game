#Red Fox Conservation Status sub-page

def redfox_conservation(): 
    import pygame
    import SpeciesMenu
    import Species_RedFox
    
    print("Red Fox conservation status is running")
    ...
    # Load all images
    RedFox_Image = pygame.image.load('./Assets/RedFox/Conservation.png')
