#Red Fox Role in the Ecosystem

def redfox_ecosystem(): 
    import pygame
    import SpeciesMenu
    import Species_RedFox
    
    print("Red Fox role in the ecosystem is running")
    ...
    # Load all images
    RedFox_Image = pygame.image.load('./Assets/RedFox/Ecosystem.png')
