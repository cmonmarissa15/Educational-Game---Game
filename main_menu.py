...
MainMenuPhoto = pygame.image.load(os.path.join('Assets',"Game_Main_Menu_Picture.png"))
MainMenuPhoto = pygame.transform.scale(MainMenuPhoto,(int(width/5),int(height/9)))
...
def drawscreen():
    ...
    screen.blit(MainMenuPhoto,(int(5*width/12),int(7*height/12)))
