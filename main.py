...
worldx3, worldy3, background3, nightbackground3, wolfGraphics3, streamAppearancesByAim3, streamNightAppearancesByAim3, streamDimensionsByAim3, streamCurveCoefficients3, treeGraphics3, treeNightGraphics3, treeGreenness3, rockGraphics3, rockNightGraphics3, decorGraphics3, decorNightGraphics3, decorDynamics3, printGraphics3, printGraphicsSmall3, miscellaneousGraphics3, miscellaneousNightGraphics3, animalTypes3, animalGraphics_3 = getWorldGraphics_chap3(globinfo['window_height'])
...
while running: # This loop runs as long as the machine does.  It must end if the
    ...
    if main_menu_action == 'stop': # at any time, ending the loop.
        ...
        if character_select(screen,menuGraphics) == 'stop':
            ...
            if chapter == 2:
                victory = run_third_chapter(screen, worldx3, worldy3, background3, nightbackground3, wolfGraphics3, streamAppearancesByAim3, streamNightAppearancesByAim3, streamDimensionsByAim3, streamCurveCoefficients3, treeGraphics3, treeNightGraphics3, treeGreenness3, rockGraphics3, rockNightGraphics3, decorGraphics3, decorNightGraphics3, decorDynamics3, printGraphics3, printGraphicsSmall3, miscellaneousGraphics3, miscellaneousNightGraphics3, animalTypes3, animalGraphics_3)
                if victory == 'stop':
                    running = False
                elif victory:
